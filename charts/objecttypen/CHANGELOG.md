...
- Added an example in the values.yaml file to reflect the expected new OIDC config.
- Removed the `CACHE_OIDC` enivornment variable, since this variable is no longer used by the application.
